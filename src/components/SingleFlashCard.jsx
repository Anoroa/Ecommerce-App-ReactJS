  ...
  return (
    <div className="max-w-67.5 w-full flex flex-col overflow-hidden mt-10">
      <div className="relative group">
        ...
        <div className="absolute bottom-5 left-0 w-full bg-black h-10.25 rounded-b-xl opacity-0 flex justify-center items-center group-hover:opacity-100 group-hover:bottom-0 transition-all duration-300">
